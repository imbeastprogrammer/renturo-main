...
type ForgotPasswordOtpFields = z.infer<typeof forgotPasswordOtpSchema>;
const defaultValues: ForgotPasswordOtpFields = { verification_code: '' };

function ForgotPasswordOtpForm() {
    const [isDisabled, setDisabled] = useState(true);
    const { countdown, reset } = useCountdown(5);
    const form = useForm<ForgotPasswordOtpFields>({ defaultValues });
