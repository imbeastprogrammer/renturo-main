...
function DeleteListingModal({ isOpen, onClose, id }: DeleteModalProps) {
    const toast = useOwnerToast();
    const handleDelete = () => {
        router.delete(`/admin/posts/${id}`, {
            onSuccess: () => {
                toast.success({
                    description: 'Listing has been removed from the system.',
                });
                onClose();
            },
            onError: (errors) =>
            ...
            <DialogContent className='max-w-[386px] space-y-2 font-outfit'>
                ...
                <DialogHeader>
                    ...
                    <DialogDescription className='text-center text-base font-thin text-black/50'>
                        This action will remove the Listing and all of their
