...
import SubOwnersTable from './components/SubOwnersTable';
    ...
    return (
        <div className='grid grid-rows-[auto_1fr_auto] gap-4 rounded-xl border bg-white p-4 shadow-lg'>
            <div className='flex justify-between'>
                ...
                <div>
                    <Link href='/admin/user-management/sub-owners/create?active=Users'>
                        <Button
                            variant='outline'
...
SubOwners.layout = (page: ReactNode) => <AdminLayout>{page}</AdminLayout>;

export default SubOwners;
