...
type CreateSubOwnerFormFields = z.infer<typeof createSubOwnerSchema>;
const defaultValues: CreateSubOwnerFormFields = {
    first_name: '',
    last_name: '',
    email: '',
    mobile_no: '',
...
function CreateSubOwnerForm() {
    const form = useForm<CreateSubOwnerFormFields>({
        defaultValues,
