...
const updateSubOwnerSchema = z.object({
...
type UpdateSubOwnerFormFields = z.infer<typeof updateSubOwnerSchema>;
const defaultValues: UpdateSubOwnerFormFields = {
    first_name: '',
    last_name: '',
    email: '',
    mobile_no: '',
...
function UpdateSubOwnerForm() {
    const form = useForm<UpdateSubOwnerFormFields>({
        defaultValues,
        resolver: zodResolver(updateSubOwnerSchema),
    });
...
export default UpdateSubOwnerForm;
